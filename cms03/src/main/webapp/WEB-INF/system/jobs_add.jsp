...
<html>
	...
	<body>
		...
		<!--添加-->
		<form action="system/jobs/add?totalPage=${totalPage}&fromAdd=1" method="post">
			<div class="form-group">
				<label for="title">工作职位</label>
				<input type="text" class="form-control" id="title" placeholder="工作职位" name="title" >
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<label class="radio-inline">
					<input type="radio" name="positiontype" id="positiontype" value="1" checked="checked">全职
				</label>
				<label class="radio-inline">
					<input type="radio" name="positiontype" id="positiontype" value="0">兼职
				</label>
			</div>
			<div class="form-group">
				<label for="isenabled">是否启用:</label>
				<label class="radio-inline">
					<input type="radio" name="isenabled" id="isenabled" value="1" checked="checked">是
				</label>
				<label class="radio-inline">
					<input type="radio" name="isenabled" id="isenabled" value="0">否
				</label>
			</div>
