//所有 productType 的 js 代码抽取到 productType.js
//入口函数：读取所有页面元素再执行
$(function () {
            ...
            if(row){
                ...
                $.messager.confirm('确认对话框', '确定要修改吗?', function(r){
                    ...
                    if (r){
                        ...
                        if(row.parent){
                            //ecombox.combobox("select",row.parent.id);
            ...
            if(row){
                ...
                $.messager.confirm('确认对话框', '确定要删除吗?', function(r){
                    ...
                    if (r){
                        ...
                        $.post("/productType/delete",{id:row.id},function (result) {
                            //判断返回信息
                            //if(msg == 'success'){
                            if(result.success){
