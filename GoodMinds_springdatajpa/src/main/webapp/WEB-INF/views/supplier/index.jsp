...
<table class="easyui-datagrid" id="supplierDataGrid"
       data-options="url:'/supplier/page',fitColumns:true,singleSelect:true,fit:true,toolbar:'#toolbar',pagination:true">
    <thead>
    <tr>
