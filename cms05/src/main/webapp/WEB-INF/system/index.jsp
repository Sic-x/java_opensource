						...
						<li class="dropdown">
							...
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
								<span class="glyphicon glyphicon-user" aria-hidden="true"></span>
									${sessionScope.username!=null?username:"管理员"}
								<span class="caret"></span>
							</a>
							<ul class="dropdown-menu">
								<li>
									<a href="system/admin/logout">注销登陆</a>
								</li>
							</ul>
						</li>
					</ul>
			...
			<div class="row">
				...
				<div class="col-md-2 col-sm-4" style="padding: 0px; position: fixed;top: 60px;left: 0px;">
					<ul id="main-nav" class="nav nav-pills nav-stacked" style="">
						<li>
							<a href="system/jobs/list" target="mainContent">
								职位管理
							</a>
						</li>
						<li>
							<a href="system/imgs/list" target="mainContent">
								轮播管理
							</a>
						</li>
				...
				<div class="col-md-10 col-md-offset-2">
					<!-- 内容展示页 -->
					<div class="main_page">
						<iframe scrolling="no" id="mainContent" name="mainContent" src="system/jobs/list" frameborder="0" src="" style="min-height:600px;width:100%;height:100%;"></iframe>
					</div>
				</div>
				<!-- /.main-content -->
			</div>
