...
<html>
	...
	<body>
		...
		<div class="container-fluid" style="margin-top: 50px">
			<div id="index-carousel" class="carousel slide" data-ride="carousel" style="height: 500px;">
				<!-- 图片上的小圆点 -->
				<ol class="carousel-indicators">
					<c:forEach items="${imgs}" var="i" varStatus="s">
						<li data-target="#index-carousel" data-slide-to="${s.index}" 
							<c:if test="${s.count==1}">
								class="active"
							</c:if>
						>
				...
				<div class="carousel-inner" role="listbox" align="center">
					<c:forEach items="${imgs}" var="i" varStatus="s">
						...
						">
							...
							<img src="uploadFile/${i.storename}" style="height: 500px;" alt="图片未找到">
		...
		<div class="container hidden-xs hidden-sm" id="footer-link">
			...
			<a href="http://www.bootcss.com" class="out-border-left">BootStrap官网</a>
		</div>
		<!--底部-->
