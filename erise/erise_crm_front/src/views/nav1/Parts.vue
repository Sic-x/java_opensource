	...
	<section>
		...
		<el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
			<el-form :inline="true" :model="filters">
				<el-form-item>
					<el-input v-model="filters.keywords" placeholder="配件名称"></el-input>
				</el-form-item>
				<el-form-item>
		...
		<el-table :data="departments" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column :formatter="timeformat" prop="createtime" label="配件入库时间"  sortable>
			</el-table-column>
		...
		<el-dialog title="编辑" :visible.sync="editFormVisible" :close-on-click-modal="false">
			...
			<el-form :model="editForm" label-width="80px" :rules="editFormRules" ref="editForm">
				<el-form-item label="配件预警数" prop="warnnum">
					<el-input v-model="editForm.warnnum" auto-complete="off"></el-input>
				</el-form-item>
			</el-form>
			<el-form :model="editForm" label-width="80px" :rules="editFormRules" ref="editForm">
				<el-form-item label="配件描述" prop="context">
					<el-input v-model="editForm.context" auto-complete="off"></el-input>
				</el-form-item>
			</el-form>
		...
		<el-dialog title="新增" :visible.sync="addFormVisible" :close-on-click-modal="false">
			<el-form :model="addForm" label-width="80px" :rules="addFormRules" ref="addForm">
				...
				<el-form-item label="配件预警数量" prop="warnnum">
					<el-input v-model="addForm.warnnum" auto-complete="off"></el-input>
				</el-form-item>
				<el-form-item label="部门描述" prop="context">
	...
	export default {
		...
		methods: {
			...
			getDepartments() {
				...
				this.$http.patch('/parts',para).then((res) => {
			...
			handleDel: function (index, row) {
				this.$confirm('确认删除该记录吗?', '提示', {
					...
					this.$http.delete('/parts/'+row.id).then((res) => {
						this.listLoading = false;
						//NProgress.done();
						this.$message({
							message: '删除成功',
				...
				this.$refs.editForm.validate((valid) => {
					if (valid) {
						this.$confirm('确认提交吗？', '提示', {}).then(() => {
                            ...
                            this.$http.post('/parts',para).then((res) => {
				...
				this.$refs.addForm.validate((valid) => {
					if (valid) {
						this.$confirm('确认提交吗？', '提示', {}).then(() => {
							...
							this.$http.put('/parts',para).then((res) => {
			...
			batchRemove: function () {
				...
				this.$confirm('确认删除选中记录吗？', '提示', {
                    ...
                    this.$http.delete('/parts/batchRemove?ids='+ids).then((res) => {
						this.listLoading = false;
						//NProgress.done();
						this.$message({
							message: '删除成功',
