...
<table class="easyui-datagrid" id="systemdictionarydetailDataGrid"
       data-options="url:'/systemDictionaryDetail/page',fitColumns:true,singleSelect:true,fit:true,toolbar:'#toolbar',pagination:true">
    <thead>
    <tr>
        <th data-options="field:'name',width:100">名称</th>
        <th data-options="field:'systemDictionaryType',width:100,formatter:typeFormat">类型</th>
...
<div id="editDialog" class="easyui-dialog" title="数据操作" style="padding: 25px; "
    ...
    <form id="editForm" method="post">
        <input id="systemDictionaryDetailId" type="hidden" name = "id" data-options="required:true">
        ...
        <table>
            ...
            <tr>
                <td> 类型</td>
                <td>
                    <input id="ecombox" class="easyui-combobox" name="systemDictionaryType.id"
                           data-options="valueField:'id',textField:'name',url:'/systemDictionaryType/findAll',panelHeight:'auto',required:true" />
                </td>
            </tr>
        </table>
    </form>
